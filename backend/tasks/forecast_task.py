...
def get_forecast_task(agent):
    return Task(
        ...
        expected_output="CSV file with material forecasts including item name, quantity, projected date of use, location of project, timeline of project (feeding schedule).",
