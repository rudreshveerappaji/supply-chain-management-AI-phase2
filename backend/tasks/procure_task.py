...
def get_procure_task(agent, forecast_context):
    return Task(
        agent=agent,
        description="Using forecast data, create purchase orders and select the best suppliers for cement, steel, and tiles - use the existing supplier catalog attached.",
